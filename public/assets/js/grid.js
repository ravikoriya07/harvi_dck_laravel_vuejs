  ...
  $(window).on("elementor/frontend/init", function () {
    setTimeout(function () {
      $(".pxl-grid").each(function (index, element) {
        ...
        var svgPaths = $(
          ".pxl-service-list .pxl-post--icon svg path, .pxl-service-list .pxl-post--icon svg line, .pxl-service-list .pxl-post--icon svg circle, .pxl-icon-list.style-5 svg path, .pxl-icon-list.style-5 svg line, .pxl-icon-list.style-5 svg circle,.pxl-icon-box7 .pxl-item--icon svg path,.pxl-icon-box7 .pxl-item--icon svg line,.pxl-icon-box7 .pxl-item--icon svg rect,.pxl-icon-box7 .pxl-item--icon svg circle",
        );
        var svgPaths_load = $(
          ".pxl-service-list .pxl-post--icon.animated svg path, .pxl-service-list .pxl-post--icon.animated svg line, .pxl-service-list .pxl-post--icon.animated svg circle, .pxl-icon-list.style-5 .animated svg path, .pxl-icon-list.style-5 .animated svg line, .pxl-icon-list.style-5 .animated svg circle",
        );
            ...
            function (e) {
              ...
              if ($this.closest(".pxl-grid-filter").hasClass("ajax")) {
                ...
                maiko_grid_ajax_handler($this, $grid_scope, $grid_isotope, {
                  action: "maiko_load_more_post_grid",
                  loadmore: loadmore,
      ...
      function maiko_check_scroll() {
        ...
        $gridItems.each(function () {
          ...
          if (
            ...
            elementBottom > $(window).scrollTop()
          ) {
        ...
        $sections.each(function () {
          ...
          $section.on("mousemove", function (e) {
            ...
            if (
              ...
              e.pageX <= sectionOffset.left + $section.width() &&
              e.pageY >= sectionOffset.top &&
              e.pageY <= sectionOffset.top + $section.height()
            ) {
              mouseX = e.pageX;
              mouseY = e.pageY;
            }
          ...
          $section.on("mouseleave", function () {
            ...
            // Ngá»«ng animation khi con trá» chuá»™t rá»i khá»i pháº§n tá»­
            gsap.to(cursor, {
      ...
      function maiko_grid_ajax_handler(
        $this,
        $grid_scope,
        $grid_isotope,
        args = {},
