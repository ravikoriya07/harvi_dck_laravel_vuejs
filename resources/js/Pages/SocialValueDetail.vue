        ...
        <div class="container pd-project-shell">
            ...
            <section class="pd-props-section">
                ...
                <div class="pd-props-bar">
                    <div v-if="socialValue.category" class="pd-prop-item">
                        <span class="pd-prop-label">Type</span>
                        <span class="pd-prop-value">{{ socialValue.category }}</span>
                    </div>
                    <div v-if="socialValue.value" class="pd-prop-item">
                        <span class="pd-prop-label">Value</span>
                        <span class="pd-prop-value">{{ socialValue.value }}</span>
                    </div>
                    <div v-if="socialValue.date" class="pd-prop-item">
                        <span class="pd-prop-label">Date</span>
                        <span class="pd-prop-value">{{ socialValue.date }}</span>
                    </div>
                    <div v-if="socialValue.status" class="pd-prop-item">
                        <span class="pd-prop-label">Status</span>
                        <span class="pd-prop-value">{{ socialValue.status }}</span>
                    </div>
                    <div v-if="socialValue.client" class="pd-prop-item pd-prop-client">
                        <span class="pd-prop-label">Client</span>
                        <span class="pd-prop-value">{{ socialValue.client }}</span>
                    </div>
                </div>
                </div>
            </section>
